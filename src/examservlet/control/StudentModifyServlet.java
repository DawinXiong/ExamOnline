...
public class StudentModifyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String uri = "jdbc:mysql://localhost:3306/exam?user=root&password=123456&serverTimezone=UTC&characterEncoding=utf-8&useSSL=false";
			...
			case 0: //模式0，增加一条数据
				...
				condition = "insert into student values (?,?,?,?,?)";
